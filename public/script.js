...
const UI = {
  en: {
    ...
    feat2Title: "3 quick diagnostics",
    feat2Text: "Test your startup's maturity, your AI leverage and your disruption risk. Each gives a score from 0 to 100 and clear priorities.",
    ...
    gateTitle: "Enter your email to see your score",
    gateText: "Your result appears instantly, right here on screen. Drop your email to unlock it.",
    gateBtn: "See my score",
    gateHint: "We only use your email for the occasional update. No spam, unsubscribe anytime.",
  ...
  es: {
    ...
    feat2Title: "3 diagnósticos rápidos",
    feat2Text: "Mide la madurez de tu startup, tu palanca de IA y tu riesgo de disrupción. Cada uno te da un score de 0 a 100 y prioridades claras.",
    ...
    gateTitle: "Escribe tu email para ver tu score",
    gateText: "Tu resultado aparece al instante, aquí en la pantalla. Deja tu email para desbloquearlo.",
    gateBtn: "Ver mi score",
    gateHint: "Usamos tu email solo para novedades ocasionales. Sin spam, cancela cuando quieras.",
  ...
  pt: {
    ...
    feat2Title: "3 diagnósticos rápidos",
    feat2Text: "Meça a maturidade da sua startup, sua alavancagem de IA e seu risco de disrupção. Cada um te dá um score de 0 a 100 e prioridades claras.",
    ...
    gateTitle: "Digite seu email para ver seu score",
    gateText: "Seu resultado aparece na hora, aqui na tela. Deixe seu email para desbloquear.",
    gateBtn: "Ver meu score",
    gateHint: "Usamos seu email só para novidades ocasionais. Sem spam, cancele quando quiser.",
